...
if __name__ == "__main__":
    ...
    torch.save(test_loader.dataset, "test_loader.pth")
    # Before training
    # print(f"Before training: {torch.cuda.memory_allocated() / 1e9:.2f} GB")
    ...
    for step in tqdm(
        ...
        # After training step
        # print(f"After training step: {torch.cuda.memory_allocated() / 1e9:.2f} GB")
        # print(f"Max allocated: {torch.cuda.max_memory_allocated() / 1e9:.2f} GB")
